...
//Box::Box( float c_x, float c_y, float s_x, float s_y )


BoundingCircle Box::GetBoundingCircle() const
{
    BoundingCircle circle(center_x, center_y, diag/2);
    return circle;
}
...
//Rhombus::Rhombus( float c_x, float c_y, float dia_x, float dia_y )
