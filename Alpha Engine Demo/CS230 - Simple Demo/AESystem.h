...
AE_API int AESysInit				(HINSTANCE hAppInstance, int show, int WinWidth, int WinHeight, int CreateConsole, unsigned int FrameRateMax, LRESULT (CALLBACK *pWinCallBack)(HWND hWnd, UINT msg, WPARAM wp, LPARAM lp));
AE_API int AESysInitGAM150			(HWND WindowHandle, int WinWidth, int WinHeight);
